...
Be aware that parenthesis are not supported in the path to the GIT_EDITOR, for example on a x64 machine where you might want to put the
file into "Program Files (x86)". This is not going to work, unfortunately.
...
Important: If you want to change the text that is appended, be sure to only include UNIX line endings, otherwise SVN will not accept the commit.